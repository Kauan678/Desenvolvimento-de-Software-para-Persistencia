/*
 * Sistema que manipula arquivos de uma entidade referente a um sistema de monitoramento de bibliotecas
 * Por Kauan Oliveira Perdigão Lopes e Luís Gustavo Rabêlo de Oliveira
 * Alunos da Universidade Federal do Ceará, campus Quixadá
 */
...
public class Main { 
    public static void main(String[] args) {
        ...
        String caminhoArquivo = "C:\\Users\\55889\\Documents\\JavaParaPersistencia\\dspersist\\Livros.csv"; 
        int escolha = 0; 
